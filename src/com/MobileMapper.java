	...
	public static class MyMapper extends Mapper<LongWritable,Text,Text,Flower>{
			...
			protected void map(LongWritable key, Text value, Context context)
				...
				// TODO Auto-generated method stub
				  Long upflow=Long.parseLong(value.toString().split("/t")[8]);
				  Long downflow=Long.parseLong(value.toString().split("/t")[9]);
				  //Long sumflow=upflow+downflow;
				  String aString=value.toString().split("/t")[0];
				  Flower flower=new Flower(upflow, downflow);
				  context.write(value,flower);
			}
	}
